    ...
    <div className="w-full px-1 sm:px-2 lg:px-3">
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-4 sm:gap-5 lg:gap-6">
        <div className="grid grid-cols-3 gap-3 sm:gap-4 lg:gap-5">
          <div className="h-[220px] rounded-xl bg-[#EEECE8] px-4 py-4 sm:h-[280px] sm:px-6 sm:py-5 lg:h-[420px] lg:px-10 lg:py-5">
        ...
        <div className="grid grid-cols-3 gap-3 sm:gap-4 lg:gap-5">
          ...
          <div className="col-span-2 h-[220px] rounded-xl bg-[#EEECE8] px-4 py-4 sm:h-[280px] sm:px-6 sm:py-5 lg:h-[420px] lg:px-10 lg:py-5">
            <p className="text-base font-semibold sm:text-xl lg:text-3xl">
              Zzzz... security to help you sleep easy every night
            </p>
          </div>
